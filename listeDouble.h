...
//Pour "AfficheListeV1" permet lire directement dans la structure de données
...
Tstation* getPtrDataFromList(T_liste l, Tstation* mydata);
...
int getOccurences(T_liste l, Tstation* data);  //nbre de fois que data est présent dans toute la liste l
